...
var checkImagesAmount=()=>{var e=document.querySelector(".file");e&&(1<e.children.length?e.classList.add("file-non-empty"):e.classList.remove("file-non-empty"))},handleRemoveImage=e=>{e.target.closest(".file__img").remove(),checkImagesAmount()},handleAddFiles=(e,r)=>{e.length&&Array.from(e).filter(e=>e.type.startsWith("image/")&&e.size<1048576).forEach(e=>{var t=document.createElement("DIV");t.classList.add("file__img"),t.innerHTML=`<img src="${URL.createObjectURL(e)}" alt="фото отзыва"><button class="file__remove" type="button" aria-label="Удалить фото"></button>`,r.parentElement.append(t),t.querySelector(".file__remove").addEventListener("click",handleRemoveImage),checkImagesAmount()})},initFileRead=()=>{var e=document.querySelector(".file__label"),t=document.querySelector(".file__input");e&&t&&t.addEventListener("change",()=>handleAddFiles(t.files,e))},initFileReadByDrop=()=>{var t,r,a=document.querySelector(".file");a&&(t=document.querySelector(".file__input"),r=document.querySelector(".file__label"),a.addEventListener("dragover",e=>{e.preventDefault()}),a.addEventListener("dragenter",e=>{e.preventDefault()}),a.addEventListener("dragover",e=>{e.preventDefault(),a.classList.add("active")}),a.addEventListener("dragleave",()=>{a.classList.remove("active")}),a.addEventListener("drop",e=>{e.preventDefault(),t.files=e.dataTransfer.files,a.classList.remove("active"),handleAddFiles(t.files,r)}))},initInputCheck=e=>{e.forEach(e=>{e.addEventListener("input",()=>{e.classList.remove("error")})})},doFormValidation=(e,t,r)=>{e=e.filter(e=>e.required);0<e.length&&e.forEach(e=>{e.value?e.classList.remove("error"):e.classList.add("error")}),0<t.lenght&&t.forEach(e=>{e.value&&(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(String(e.value).toLowerCase())?e.classList.remove("error"):e.classList.add("error"))}),0<r.length&&r.forEach(e=>{e.value&&(16===e.value.length?e.classList.remove("error"):e.classList.add("error"))})},checkErorrs=e=>{return!e.some(e=>e.classList.contains("error"))},initFormValidation=()=>{var e,t,r,a,l,i=document.querySelector(".feedback"),n=document.querySelector(".feedback__form");i&&n&&(l=n.querySelectorAll(".feedback__input"),e=n.querySelectorAll(".feedback__textarea"),0<(t=[...l,...e]).length&&initInputCheck(t),r=t.filter(e=>"email"===e.type),0<(a=t.filter(e=>"user_phone"===e.name)).length&&(l=Maska["MaskInput"],new l("[data-maska]")),n.addEventListener("submit",e=>{e.preventDefault(),doFormValidation(t,r,a),checkErorrs(t)&&(n.reset(),i.classList.add("success"))}))};document.addEventListener("DOMContentLoaded",()=>{initFileRead(),initFileReadByDrop(),initFormValidation()});